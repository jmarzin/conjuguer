...
ActiveRecord::Schema.define(version: 20140509202734) do
  ...
  add_index "conjugaisons", ["id"], name: "index_conjugaisons_on_id", using: :btree
  ...
  create_table "vocabulaires", force: true do |t|
    t.string   "francais"
    t.string   "italien"
    t.integer  "compteur"
    t.datetime "created_at"
