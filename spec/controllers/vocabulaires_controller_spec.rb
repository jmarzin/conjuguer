...
describe VocabulairesController do
  ...
  # VocabulairesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET new" do
    it "assigns a new vocabulaire as @vocabulaire" do
      get :new, {}, valid_session
      assigns(:vocabulaire).should be_a_new(Vocabulaire)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Vocabulaire" do
        expect {
          post :create, {:vocabulaire => valid_attributes}, valid_session
        }.to change(Vocabulaire, :count).by(1)
      end

      it "assigns a newly created vocabulaire as @vocabulaire" do
        post :create, {:vocabulaire => valid_attributes}, valid_session
        assigns(:vocabulaire).should be_a(Vocabulaire)
        assigns(:vocabulaire).should be_persisted
      end

      it "redirects to the created vocabulaire" do
        post :create, {:vocabulaire => valid_attributes}, valid_session
        response.should redirect_to(Vocabulaire.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved vocabulaire as @vocabulaire" do
        # Trigger the behavior that occurs when invalid params are submitted
        Vocabulaire.any_instance.stub(:save).and_return(false)
        post :create, {:vocabulaire => { "francais" => "invalid value" }}, valid_session
        assigns(:vocabulaire).should be_a_new(Vocabulaire)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested vocabulaire" do
        ...
        Vocabulaire.any_instance.should_receive(:update).with({ "francais" => "MyString" })
        put :update, {:id => vocabulaire.to_param, :vocabulaire => { "francais" => "MyString" }}, valid_session
      end
